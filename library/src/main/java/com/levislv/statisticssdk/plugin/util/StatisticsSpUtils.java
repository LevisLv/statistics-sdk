...
public class StatisticsSpUtils {
    ...
    private static final String SP_NAME = "statistics-gradle-plugin";

    private SharedPreferences sp;

    private volatile static StatisticsSpUtils instance;

    public static StatisticsSpUtils getInstance() {
        if (instance == null) {
            synchronized (StatisticsSpUtils.class) {
                if (instance == null) {
                    instance = new StatisticsSpUtils();
                }
            }
        }
    ...
    private StatisticsSpUtils() {
        sp = Statistics.context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
    }
